    ...
    <div class="container 2xl:w-[1200px] mx-auto flex">
        <div class="w-1/4 mr-4">
            <div class="user-box border text-center p-6 relative">
                ...
                @endif
                <div class="font-bold text-lg"><a href="/profile">{{ Auth::user()->name}}</a></div>
        ...
        <div class="overlay hide fixed top-0 left-0 right-0 bottom-0 z-10"></div>
        <div class="pt-10 hide box-naptien bg-white border fixed bottom-1/2 right-1/2 translate-x-1/2 translate-y-1/2 z-10 text-center">
            <h2 class="font-bold text-xl">NẠP TIỀN</h2>
            <p>Chọn mệnh giá</p>
            <a href="/profile/naptien?tien=100000" class="flex border-b mt-5 px-10 py-3">100,000 đ <svg width="24px" class="ml-10" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 12H18M18 12L13 7M18 12L13 17" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg></a>
            <a href="" class="flex border-b px-10 py-3">200,000 đ <svg width="24px" class="ml-10" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 12H18M18 12L13 7M18 12L13 17" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg></a>
            <a href="" class="flex px-10 py-3">500,000 đ <svg width="24px" class="ml-10" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 12H18M18 12L13 7M18 12L13 17" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg></a>
            {{-- <div class="flex px-10 py-3">
                <div class="flex-col flex">
                    <label for="money" class="text-sm font-medium mb-1 inline-block text-left">Tùy chọn</label>
                    <div class="flex">
                        <input name="money" id="money" min='0' class="w-[100px] input-form px-3 py-2 border border-gray-300 text-sm" type="number" required/>
                        <a href="" class="flex items-center">
                    <svg width="24px" class="ml-5" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 12H18M18 12L13 7M18 12L13 17" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg></a>
                    </div>
                </div>
...
<script>
    function updateCountdown() {
        ...
        var endTime = new Date('2023-09-25 12:22:46');
