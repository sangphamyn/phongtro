                ...
                <div class="wrapper flex">
                    <div class="counter col_fourth w-1/3">
                        <a href="dadang" class="flex justify-center items-center">
							...
							<div>
                                <h2 class="timer count-title count-number text-red-800 underline">{{ $dad }}</h2>
            ...
            @foreach ($posts as $post)
                ...
                <div class="post-item border flex px-5 py-4 mb-4">
                    ...
                    <div class="post-info ml-5">
                        <a href="/post/{{ $post->id }}"><h1 class="post-title font-semibold mb-1 text-lg">{{Str::of($post->title)->words(20, '...')}} - @if($post->trangthai == 1) Còn phòng @else Hết phòng @endif</h1></a>
                        ...
                        <div class="post-address text-sm flex text-[#383838] mb-3">
                        ...
                        @if($post->trangthai==1)     
                        <a href="/post/hetphong?id={{ $post->id }}" class="button-5">Đặt trạng thái đã hết phòng</a>
                        @else <a href="/post/conphong?id={{ $post->id }}" class="button-5" style="background: #4ad1e5">Đặt trạng thái còn phòng</a>
                        @endif
                    </div>
