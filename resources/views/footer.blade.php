<footer>
    <div class="2xl:px-20 container mx-auto footer flex justify-between py-10">
        ...
        <div class="w-1/5 px-4 footer-column">
            ...
            <p>
                <a href="/" class="link-menu py-1 block">Khuyến mại</a>
            </p>
        </div>
    </div>
</footer>